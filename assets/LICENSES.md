...
|---|---|---|---|
| Soldier glTF model and animation (the armed human and the unarmed survivor) | Adobe Mixamo, distributed in [Three.js r185 examples](https://github.com/mrdoob/three.js/tree/r185/examples/models/gltf) | [Mixamo royalty-free use in games](https://helpx.adobe.com/creative-cloud/faq/mixamo-faq.html); not CC0 or a standalone asset pack | Weathered cloth materials, normalization, weapon attachment, animation blending |
| Xbot glTF model and animation (the humanoid machines: worker, striker, launcher, anvil, colossus) | Adobe Mixamo, distributed in [Three.js r185 examples](https://github.com/mrdoob/three.js/tree/r185/examples/models/gltf) | Same Mixamo terms | Dome head and pectorals sculpted away, chrome and gunmetal materials, procedural skull with red optics, faction armbands and stripes, per-type fittings (drill, plasma rifle, rocket rack, shield, cannon) attached to the bones; idle/walk blending. The other machines are procedural (`web/src/three/UnitModels.ts`) |
