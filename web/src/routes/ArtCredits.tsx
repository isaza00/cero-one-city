...
export default function ArtCredits() {
  return <div className="card" style={{ maxWidth: 850, margin: "32px auto" }}>
    ...
    <h1>World credits</h1>
    <p>The battlefield combines two rigged characters, scanned surface materials, and original mechanical units and
    ...
    <p>The armed human and the unarmed survivor use the Soldier by Adobe Mixamo, distributed with the Three.js
      ...
      incorporated in the game, not offered as a standalone model library. The humanoid machines (worker, striker,
      launcher, anvil, colossus) are built on the Xbot, also by Adobe Mixamo from the Three.js examples, sculpted and
      dressed here: chrome over gunmetal, a metal skull with red optics, faction armbands, and their tools and weapons
      attached to the rig. The
      other machines - walkers, cycles, aircraft, drones, tripods, crawlers - are original procedural geometry made
      for Cero One City.</p>
