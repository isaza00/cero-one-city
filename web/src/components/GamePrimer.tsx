    ...
    <details className="card primer" open={defaultOpen}>
      ...
      <div className="primer-grid">
        ...
        <p><strong>How to win:</strong> destroy every enemy core, or have the most
          points when the match ends at turn 40. Lose your core and you're out.</p>
        ...
        <p><strong>Three resources:</strong> energy (harvested; every unit costs 1
          per turn), metal (limited - mines run dry, wrecks become scrap), and
          compute (caps your army size; build racks to think bigger).</p>
